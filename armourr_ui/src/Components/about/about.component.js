				...
				<div className="container">
					<div className="row">
						...
						<div className="tab-titles">
							<p className="tab-links active-link quality" onClick={() =>
									this.opentab('quality')}
									>Quality</p>
							<p className="tab-links approval"  onClick={() =>
									this.opentab('approval')}>Approval</p>
							<p className="tab-links surety"  onClick={() =>
									this.opentab('surety')}>Surety</p>
						</div>
						
						<div className="tab-contents active-tab" id="quality" >
							<ul>
								<li><span>Thread Count</span><br />Number of thread strands per inch in ___</li>
								<li><span>High Quality Fiber</span><br />Closely and tightly woven together which helps in well balanced and vertical and horizontal weaves</li>
								<li><span>Material Used.</span><br />We Use ____</li>
							</ul>
						</div>

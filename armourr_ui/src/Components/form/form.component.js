...
function FormExample() {
	...
	const myfunc = () => {
		const scriptURL =
			"https://script.google.com/macros/s/AKfycbxsu6lKcECQuGbpdWctTtPmRBbSW1iXgoxn3f4jhzAAXyiAS__UG7al2hCQMeSTDaNgFQ/exec";
			...
			<Container>
				<Row className="mb-3">
					...
					<Form.Group as={Col} md="6" controlId="validationCustom02">
						...
						<Form.Control required name="Birthdate" type="date" />
						<Form.Control.Feedback>
							Looks good!
						</Form.Control.Feedback>
						<Form.Control.Feedback type="invalid">
